...
MAJOR_PORTS: list[tuple[str, float, float, list[str]]] = [
    ...
    ("New York",      40.68,  -74.04,
     ["new york port", "newark port", "port authority", "boston port", "east coast port"]),
    ...
    ("Colon",          9.36,  -79.90,
     ["panama canal", "colon port", "balboa", "cristobal"]),
    ...
    ("Hong Kong",     22.29,  114.17,
     ["hong kong", "shenzhen", "shekou", "chinese port"]),
    ("Busan",         35.10,  129.03,
     ["busan", "korean port"]),
    ("Qingdao",       36.07,  120.38,
     ["qingdao", "dalian", "chinese port"]),
    ("Tokyo",         35.65,  139.84,
     ["tokyo", "japanese port"]),
    ...
    # ── Middle East ─────────────────────────────────────────
    ("Dubai",         25.28,   55.30,
     ["dubai", "jebel ali", "khalifa port", "abu dhabi", "salalah", "oman", "persian gulf", "gulf state", "hormuz"]),
    ("Jeddah",        21.49,   39.19,
     ["jeddah", "red sea"]),
    # ── Africa ──────────────────────────────────────────────
    ("Durban",       -29.86,   31.02,
    ...
    ("Port Said",     31.26,   32.30,
     ["port said", "suez canal", "suez", "red sea", "casablanca", "morocco"]),
    # ── Oceania ─────────────────────────────────────────────
    ("Sydney",       -33.86,  151.20,
     ["sydney port"]),
